...
RUN export RUBY_BUILD_MIRROR_URL={{ paas.ruby_build_mirror }} && /home/{{ paas.user }}/ruby-build/bin/ruby-build 2.2.0 /home/{{ paas.user }}/.ruby-2.2.0
ENV PATH=/usr/sbin:/usr/bin:/sbin:/bin:/usr/local/bin:/usr/local/sbin:/home/{{ paas.user }}/.ruby-2.2.0/bin
